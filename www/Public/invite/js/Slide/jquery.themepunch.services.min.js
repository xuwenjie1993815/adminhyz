(function(a, b) {
    ...
    function g(c, f) {
        ...
        c.find("ul:first").wrap('<div style="position:absolute;top:0px;left:0px; height: 200px;" class="services-wrapper-top"></div>');
        ...
        c.find("ul:first > li").each(function(c) {
            ...
            d.wrapInner('<div class="slide" style="position:absolute; overflow:hidden;width:' + f.slidewidths + "px;top:0px;left:" + f.positionArray[c] + 'px;"></div>');
            var g = d.find(".slide");
            g.css({
                ...
                g.hover(function() {
                        ...
                        if (c.data("link") == true) {
                            if (c.find(".hover-blog-link-sign").length == 0) {
                                d.append('<div class="hover-blog-link-sign" style="z-index:999;margin-left:-125px;margin-top:-25px"></div>');
    ...
    function h(a, b) {
        a.find("ul:first").wrap('<div class="main-container" style="top:0px;left:0px;width:' + b.width + "px;height:" + b.height + 'px;overflow:hidden"><div class="slider_holder" style="position:relative;width:' + b.width + "px;height:" + b.height + 'px;overflow:hidden"></div></div>');
